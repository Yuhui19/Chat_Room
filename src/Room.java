...
public class Room {
    ...
    public String name;
    private ArrayList<SocketChannel> allClient = new ArrayList<>();
    private ArrayList<SocketChannel> pendingClient = new ArrayList<>();
        ...
        while (true) {
            ...
            while (keyIterator.hasNext()) {
                ...
                if (key.isReadable()) {
                    ...
                    WebSocket response = new WebSocket();
    ...
    public synchronized void post(WebSocket response) throws IOException {
